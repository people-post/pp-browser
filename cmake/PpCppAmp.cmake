...
pp_fetch_git_tag(PP_CPP_AMP_GIT_TAG "e29234093b2cc5afcbd6202e4e0363c4f88f929b"
  "pp-cpp-amp /ip6 ADP multiaddrs (cursor/adp-ipv6-multiaddr)")
...
elseif(EXISTS "${_pp_amp_sibling}/CMakeLists.txt")
  ...
  message(STATUS "pp-browser: using sibling pp-cpp-amp at ${_pp_amp_src}")
else()
  set(_pp_amp_src "")
endif()
