...
pp_require_vendored(libdatachannel)
...
# libdatachannel (WebRTC transport for a2+ calls). Uses BoringSSL via cmake/modules/FindOpenSSL.cmake.
...
add_subdirectory("${PP_THIRD_PARTY_DIR}/libdatachannel"
                 "${CMAKE_BINARY_DIR}/third_party/libdatachannel" EXCLUDE_FROM_ALL)
if(TARGET datachannel-static)
  set(PP_BROWSER_DATACHANNEL_TARGET datachannel-static)
elseif(TARGET datachannel)
  set(PP_BROWSER_DATACHANNEL_TARGET datachannel)
elseif(TARGET LibDataChannel::LibDataChannelStatic)
  set(PP_BROWSER_DATACHANNEL_TARGET LibDataChannel::LibDataChannelStatic)
elseif(TARGET LibDataChannel::LibDataChannel)
  set(PP_BROWSER_DATACHANNEL_TARGET LibDataChannel::LibDataChannel)
else()
  message(FATAL_ERROR "libdatachannel target not found after add_subdirectory")
endif()
