...
function(compile_proto_to_cpp PROTO_LIBRARY_NAME PB_H PB_CC PROTO)
  ...
  if (NOT Protobuf_INCLUDE_DIR AND PACKAGE_MANAGER STREQUAL "vendored")
  ...
  if (NOT Protobuf_PROTOC_EXECUTABLE AND TARGET protoc)
  ...
  # Path relative to libp2p/src matches protoc --cpp_out layout (-I${PROJECT_SOURCE_DIR}/src).
  file(RELATIVE_PATH SCHEMA_REL "${PROJECT_SOURCE_DIR}/src" "${CMAKE_CURRENT_SOURCE_DIR}")
