...
if (PACKAGE_MANAGER STREQUAL "vendored")
  ...
  pp_libp2p_require_target(protobuf::libprotobuf)
  pp_libp2p_require_target(protobuf::protoc)
  ...
  set(Protobuf_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/third_party/protobuf/src" CACHE INTERNAL "")
  return()
endif()
