 ...
 *  Shared vocabulary for mesh L4 + people hop policy — lives in common so domain
 *  peers (mesh, people) need not include each other. */
...
/** Whether an inbound relay dialer may use this node (N023 / nf). Header-only. */
