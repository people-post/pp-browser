...
public:
  ...
  AmpBroadcastService(IChatPeerLinks& links, IoPump io_pump, WorkerPost post_worker = {});
  ~AmpBroadcastService();

  AmpBroadcastService(const AmpBroadcastService&) = delete;
  AmpBroadcastService& operator=(const AmpBroadcastService&) = delete;
