...
ThreadPeerLinkView P2pMessagingService::GetThreadPeerLink(const std::string& thread_id) const {
...
void P2pMessagingService::NotifyRelayFallback(const std::string& thread_id) {
