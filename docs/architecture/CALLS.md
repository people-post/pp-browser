...
| **CallMediaAdpPath** | Optional **Opus-only** BestEffort side-path over ADP UDP (`libp2p.adp_opus`); hello advertises `adp_*`; falls back to stream Opus ([projects/adp](../../projects/adp/)) |
