...
**A017 (2026-08-31):** Host / TCP / Yamux / Noise / QUIC / Identify / Kademlia / Gossip were **deleted**. The fork retains **PeerId + key wire** only (`p2p_peer_id`, `p2p_wire`). Product mesh is Amp (`base/adp` + `base/mesh`).
