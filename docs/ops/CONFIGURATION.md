...
| `ProfilePreferences` | `ConfigApplyBridge` (`Prefs{.language=…}`) | `LocalizationService::Prefs` | `LocalizationService::Apply` (UI chrome via language listeners) |
