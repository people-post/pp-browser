...
**Vendored source** under [`third_party/`](../../third_party/): curl, SQLite (amalgamation), Opus, and (for libp2p) BoringSSL, Boost, lsquic, and related packages. nlohmann/json comes from [`pp-cpp-common`](https://github.com/people-post/pp-cpp-common) (sibling or FetchContent; optional `third_party/nlohmann_json` fallback). libsodium + ML-KEM/ML-DSA come from [`pp-cpp-crypto`](https://github.com/people-post/pp-cpp-crypto); RmlUi + FreeType/HarfBuzz/LunaSVG + SDL3/SDL3_image from [`pp-cpp-ui`](https://github.com/people-post/pp-cpp-ui) (sibling or FetchContent).
