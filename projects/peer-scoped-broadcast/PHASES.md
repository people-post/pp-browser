...
- [x] **Admit-or-redirect:** domain `BroadcastLadderLogic` + `BroadcastRpcCodec` viewer_attach(_result); `AmpBroadcastTransport` handler
- [x] **Slot win:** domain + `BroadcastRpcCodec` relay_slot_win(_result); `AmpBroadcastTransport` handler
