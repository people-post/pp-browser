...
**Status:** Design sketch accepted (2026-09-05); **Spine B in progress** (ML-DSA tips, Amp 1:1, IdentityStore publisher + peer_id resolve) — see [CURRENT_STATE](CURRENT_STATE.md)  
