...
**Recent:** D079–D082 (contact vs communicating identity; public ephemeral inbound; peer signing key lookup E016; relay identity format) — see [DECISIONS.md](DECISIONS.md)
