...
| Area | Location | Notes |
|------|----------|-------|
| v6 pipeline + classifier + integrity + c2 crypto | `src/base/messaging/tests/` | `v6_pipeline_test`, `e2e_ingest_classifier_test`, `v6_integrity_test`, `e2e_relay_crypto_test` |
| Sync + gap + scroll + compromised | `chat_sync_test` | **13 tests** |
| Cross-cutting ingest/dedup/routing | `messaging_cross_cutting_test` | dedup, oversize, find-only, tier paths |
