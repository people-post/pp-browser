...
**Related:** [relay-blob-upload](../relay-blob-upload/) (attachments MVP shipped), [at-rest-crypto](../at-rest-crypto/), [peer-scoped-broadcast](../peer-scoped-broadcast/) ([program board](../peer-scoped-broadcast/PROGRAM.md)) (announce tips → optional DVR in CAS)
