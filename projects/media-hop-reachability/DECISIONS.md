...
**Decision:** This project owns the **program and consume contract**. **Implementation of reachability** lives in the **vendored libp2p fork** and `src/base/p2p/` (Identify, addr book, DialBack, circuit, later hole punch). Calls/mesh **consume** dialability; they do not reimplement NAT traversal.  
