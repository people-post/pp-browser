...
| [feature-layer-reorg](feature-layer-reorg/) | **f6 done** — f7 `src/gui/` next | F008: gui above feature; `feature/ui` staging — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
