...
| [feature-layer-reorg](feature-layer-reorg/) | **f3 landed** — f4v1 next | Feature/app cleanup after foundation+domain; sure peels first, revisable North Star — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
