...
| [p2p-av-calls](p2p-av-calls/) | **a1 done** — a2 next | 1:1/group voice+video; WebRTC media + mesh SFU; invite guests; `call_wake` — [CURRENT_STATE](p2p-av-calls/CURRENT_STATE.md) |
