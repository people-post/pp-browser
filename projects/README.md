...
| [relay-blob-upload](relay-blob-upload/) | **i1 blob client landed** — **i2** icon UX next | Profile icons (i2–i3) then E2E chat attachments (a1–a5) — [CURRENT_STATE](relay-blob-upload/CURRENT_STATE.md) |
