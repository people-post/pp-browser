...
| [p2p-mesh](p2p-mesh/) | **n3 done** — nf + n4-media next | True SFU for calls a4 (N017); message_relay/pricing deferred — [CURRENT_STATE](p2p-mesh/CURRENT_STATE.md) |
| [p2p-av-calls](p2p-av-calls/) | **a3 done**; **a4** gated on SFU | True SFU required (V020); no full-mesh — [CURRENT_STATE](p2p-av-calls/CURRENT_STATE.md) |
