...
| [feature-layer-reorg](feature-layer-reorg/) | **calls lift + conversations rename** | `feature/calls`; soft AI/call ports — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
