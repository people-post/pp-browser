...
| [feature-layer-reorg](feature-layer-reorg/) | **f1+f2 peels landed** — f3 next | Feature/app cleanup after foundation+domain; sure peels first, revisable North Star — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
