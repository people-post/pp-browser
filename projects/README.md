...
| [multi-device-account](multi-device-account/) | **m4b paste path landed** — unlink / `endpoints[]` next | Account ID on wire; shared DEK + account KEM + first-run link-device — [DESIGN](multi-device-account/DESIGN.md) |
