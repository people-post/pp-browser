...
| [feature-layer-reorg](feature-layer-reorg/) | **f0 docs** — f1 peels next | Feature/app cleanup after foundation+domain; sure peels first, revisable North Star — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
