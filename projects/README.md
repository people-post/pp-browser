...
| [feature-layer-reorg](feature-layer-reorg/) | **conversations rename + f7/f6** | `src/gui/`; `feature/conversations`; soft AI ports — [CURRENT_STATE](feature-layer-reorg/CURRENT_STATE.md) |
