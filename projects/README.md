...
| [p2p-mesh](p2p-mesh/) | **n3 done** — nf + n4-media next | N021 framing/QoS; N020 pick; pricing-as-regulation — [CURRENT_STATE](p2p-mesh/CURRENT_STATE.md) |
| [p2p-av-calls](p2p-av-calls/) | **a3 done**; **a4** gated | V024 one policy / two backends (1:1 P2P + SFU) — [CURRENT_STATE](p2p-av-calls/CURRENT_STATE.md) |
