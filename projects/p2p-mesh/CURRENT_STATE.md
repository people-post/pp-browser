...
| ADRs | N001–**N026** in [DECISIONS.md](DECISIONS.md) (N026 = media-relay attach SM — **design only**) |
...
2. **N026** — implement attach SM only after [V033](../p2p-av-calls/DECISIONS.md#v033--transport-session-machines-not-host-wide-inbound-sm) call-media SM lessons  
