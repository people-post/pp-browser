...
| Bridge score / LAN mDNS | Deferred (ns2); multi-hop circuit plan [ns3](PHASES.md#ns3--multi-hop-circuit-policy) / [N024](DECISIONS.md#n024--circuit-pricing-pay-immediate-relay-only) |
