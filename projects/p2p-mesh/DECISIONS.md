...
**Date:** 2026-08-07  
**Status:** Accepted (**s3a+s3b done** — inbound + client attach phases in code; circuit compose loopbacks green; after call-media [V033](../p2p-av-calls/DECISIONS.md#v033--transport-session-machines-not-host-wide-inbound-sm) s2a)  
...
**Rationale:** Customers pin Account ID / org handle, not Peer ID; durable volume keeps Peer ID across container redeploys; people search stays clean; decentralization needs swappable registries.
