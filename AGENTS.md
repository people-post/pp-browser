...
- **Third-party libs** — curl and libp2p deps in [`third_party/`](third_party/); nlohmann/json via [`pp-cpp-common`](https://github.com/people-post/pp-cpp-common) (optional local fallback); libsodium + PQ via [`pp-cpp-crypto`](https://github.com/people-post/pp-cpp-crypto); RmlUi + FreeType / HarfBuzz / LunaSVG + SDL3 / SDL3_image via pp-cpp-ui
