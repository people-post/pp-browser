...
| At-rest encryption (PIN vault) | `src/base/crypto/DataKeyVault.*`, `PinGateController`, [docs/AT_REST_ENCRYPTION.md](docs/AT_REST_ENCRYPTION.md) — [projects/at-rest-crypto/](projects/at-rest-crypto/) |
