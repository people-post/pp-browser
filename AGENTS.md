...
| Libp2p node roles (role + caps + relay pricing) | [projects/libp2p-node-roles/](projects/libp2p-node-roles/) — Client/Node; billable relays settle on chain (N010); seed :443; n1 next |
