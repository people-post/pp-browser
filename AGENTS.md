...
| Profile icons / chat attachments | [projects/relay-blob-upload/](projects/relay-blob-upload/) — **a1–a4 done**; **a6 done** — Smart policy, suppression, peer chat-blob, fetch ladder, outbound peer upload |
