...
| P2P A/V calls | [projects/p2p-av-calls/](projects/p2p-av-calls/) — voice/video over mesh; libdatachannel + Opus + SDL; invite guests; **a3** done (LAN 1:1 video); **a4** next (group ≤8; SFU vs LAN mesh TBD) |
