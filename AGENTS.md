...
| P2P A/V calls | [projects/p2p-av-calls/](projects/p2p-av-calls/) — **a4 thin** landed (SFU soft-migrate + V024); polish next; code map [docs/architecture/CALLS.md](docs/architecture/CALLS.md) |
