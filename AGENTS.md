...
| E2E message crypto (planning) | [projects/e2e-message-crypto/](projects/e2e-message-crypto/) — PSK, libsodium, AEAD; spec in [docs/MESSAGE_ENCRYPTION.md](docs/MESSAGE_ENCRYPTION.md) |
