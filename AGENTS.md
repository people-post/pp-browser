...
| P2P A/V calls | [projects/p2p-av-calls/](projects/p2p-av-calls/) — voice/video over mesh; libdatachannel + Opus + SDL; invite guests; **a2** done (LAN voice); **a3** in progress (unified Opus+H264; HW codecs next) |
