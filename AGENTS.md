...
| P2P mesh | [projects/p2p-mesh/](projects/p2p-mesh/) — **nf** + **n4-media** next (N018–N021: framing/QoS, quotes, contacts∪seed) |
| P2P A/V calls | [projects/p2p-av-calls/](projects/p2p-av-calls/) — **a3** done; **a4** V020–V024 (**shared** adaptive 1:1+SFU) |
